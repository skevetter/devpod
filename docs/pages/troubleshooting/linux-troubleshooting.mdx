...
There is a [known issue](https://github.com/skevetter/devpod/issues/1045) where some linux distros use a large PATH to find SSH and causes the connection string to be too long. The workaround is to specify
