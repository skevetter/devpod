...
Since DevPod's target environment is a Docker container, you can also SSH into it and install your vim/neovim configuration like you would on any new machine.
