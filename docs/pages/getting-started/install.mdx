...
- [Linux Targz](https://github.com/skevetter/devpod/releases/latest/download/DevPod_linux_x86_64.tar.gz)
...
```bash
curl -L -o devpod "https://github.com/skevetter/devpod/releases/latest/download/devpod-darwin-amd64" && sudo install -c -m 0755 devpod /usr/local/bin && rm -f devpod
```
...
Invoke-WebRequest -URI "https://github.com/skevetter/devpod/releases/latest/download/devpod-windows-amd64.exe" -OutFile $Env:APPDATA\devpod\devpod.exe;
...
```bash
curl -L -o devpod "https://github.com/skevetter/devpod/releases/latest/download/devpod-linux-arm64" && sudo install -c -m 0755 devpod /usr/local/bin && rm -f devpod
```
